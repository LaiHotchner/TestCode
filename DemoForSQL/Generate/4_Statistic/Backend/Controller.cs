...
namespace CodeSqlGenerate.Generate._4_Wait_Statistic.Backend
{
    public static class Controller
    {
        ...
        private static string GetContent()
        {
            ...
            stringBuilder.AppendLine($"            {Entity.StatisticSummaryClass} summary = {filedName}.{Backend_Statistic.GetAllStatisticResult_MethodName}(adminCode);");
            stringBuilder.AppendLine("            return setResultSuccess(summary);");
